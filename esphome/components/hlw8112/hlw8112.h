...
static const float HLW8112_IREF = 324004 * 1 / 1.218;
static const float HLW8112_UREF = 79931 * 0.51 * 1000 / (1.218 * (5 * 390 + 0.51));
static const float HLW8112_PREF = 4046 * 1 * 0.51 * 1000 / (1.218 * 1.218 * (5 * 390 + 0.51));
static const float HLW8112_EREF = 3.6e6 * 4046 * 1 * 0.51 * 1000 / (1638.4 * 256 * 1.218 * 1.218 * (5 * 390 + 0.51));
...
class HLW8112 : public PollingComponent, public uart::UARTDevice {
 ...
 protected:
  ...
  float power_reference_ = HLW8112_PREF;
  // Divide by this to turn into Volt
  float voltage_reference_ = HLW8112_UREF;
  // Divide by this to turn into Ampere
  float current_reference_ = HLW8112_IREF;
  // Divide by this to turn into kWh
  float energy_reference_ = HLW8112_EREF;
